...
class AudiobookPriceCalculatorTest {
    ...
    @Test
    public void test1(){
        customer=new Customer("Mateusz", Customer.LoyaltyLevel.STANDARD,true);
        assertEquals( calculator.calculate(customer,audiobook),0.0);
    }
    @Test
    public void test2(){
        customer=new Customer("Mateusz",Customer.LoyaltyLevel.SILVER,false);
    ...
    @Test
    public void test3(){
        customer=new Customer("Mateusz",Customer.LoyaltyLevel.GOLD,false);
        calculator.calculate(customer,audiobook);
        assertEquals( calculator.calculate(customer,audiobook),audiobook.getStartingPrice()*0.8);
    }
    @Test
    public void test4(){
        customer=new Customer("Mateusz",Customer.LoyaltyLevel.STANDARD,false);
        calculator.calculate(customer,audiobook);
